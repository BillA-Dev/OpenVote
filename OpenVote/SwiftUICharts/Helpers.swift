...
public struct Colors {
    ...
    public static let IndicatorKnob:Color = Color(hexString: "#10a0cf")
    ...
    public static let openvoteBlue: Color = Color(hexString: "#20274b")
    public static let openvoteLightBlue: Color = Color(hexString: "#10a0cf")
    public static let openvoteGray: Color = Color(hexString: "#efefef")
    ...
    public static let redactedGray: Color = Color(hexString: "#9E9E9E")
...
public struct ChartForm {
    ...
    public static let large = CGSize(width:300, height:180)
